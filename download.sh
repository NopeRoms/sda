...
CCACHE_FILE="main_ccache.tar.gz"
...
cd /tmp
url=https://totallynotmirrorbot.goololdindex.workers.dev/0:/main_ccache.tar.gz
...
mv main_ccache.tar.gz ccache.tar.gz # Rename back to original folder name before extracting
